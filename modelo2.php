...
<head>
 ...
 <title> Google Maps API v3: Criando um mapa personalizado </title>
	<link rel="stylesheet" href="mapa2.css">
...
<div class="toggle-btn-grp cssonly">
    <div><a href="modelo2.php?tipo=visual" title="Ìcone Visual">
	<input type="radio" name="group4"/>
	<label onclick="modelo2.php?tipo=visual" class="toggle-btn">Ícone Visual</label></a>
</div>
    <div><a href="modelo2.php?tipo=simbolico" title="Ìcone Simbólico">
<input type="radio" name="group4"/>
<label onclick="modelo2.php?tipo=simbolico" class="toggle-btn">Ícone Simbólico</label></a>
</div>
    <div><a href="modelo2.php?tipo=alerta" title="Ìcone de Alerta"><input type="radio" name="group4"/><label onclick="modelo2.php?tipo=alerta" class="toggle-btn">Alerta</label></a></div>
</div>
...
<META HTTP-EQUIV='REFRESH' CONTENT='300; URL=modelo2.php'>
</body>
